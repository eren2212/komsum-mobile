...
function ShopIconSection({ shopName }: { shopName: string }) {
    ...
    return (
        <View className="items-center mb-8">
            <View
                className="w-[80px] h-[80px] rounded-[24px] bg-[#FFF1EE] items-center justify-center mb-2.5 border-2 border-[rgba(255,107,74,0.15)]"
            >
                <Text
...
export default function MerchantEditScreen() {
    ...
    const { mutate: updateProfile, isPending, error } = useMutation({
        ...
        onSuccess: () => {
            ...
            Alert.alert(
                "Başarılı",
                "İşletme bilgileriniz güncellendi.",
                ...
                >
                    ...
                    <View className="flex-row items-start gap-3 rounded-2xl p-4 mb-2 bg-[#FFF1EE]">
                        ...
                        <Text className="flex-1 text-[12px] text-neutral-500 leading-[18px]">
                            Güncellenen bilgiler anında profilinize yansır. Onay gerektiren değişiklikler için destek ekibiyle iletişime geçin.
                        </Text>
                    </View>
